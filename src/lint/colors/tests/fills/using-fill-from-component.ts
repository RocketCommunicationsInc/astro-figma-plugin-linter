      ...
      switch (true) {
        case !!overriddenFields && overriddenFields.includes("fillStyleId"): {
          resolve({
            ...
            pass: false,
            message:
              "Layer is not using the same fill style as the source Astro component.",
          });
          break;
        }
        ...
        case !!overriddenFields && overriddenFields.includes("fills"): {
          resolve({
            ...
            pass: false,
            message:
              "Layer is not using the same fill as the source Astro component.",
          });
          break;
        }
        ...
        case !overriddenFields: {
          resolve({
            ...
            pass: true,
            message:
              "Layer is using the same fill style as the source Astro component.",
          });
          break;
        }
